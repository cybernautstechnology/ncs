...
<head>
    ...
    {!! Html::style('resources/assets/lib/perfect-scrollbar/css/perfect-scrollbar.css') !!}
    {!! Html::style('resources/assets/lib/jquery-switchbutton/jquery.switchButton.css') !!}
    {!! Html::style('resources/assets/lib/rickshaw/rickshaw.min.css') !!}
    {!! Html::style('resources/assets/lib/chartist/chartist.css') !!}
...
{!! Html::script('resources/assets/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.js') !!}
{!! Html::script('resources/assets/lib/moment/moment.js') !!}
{!! Html::script('resources/assets/lib/jquery-ui/jquery-ui.js') !!}
{!! Html::script('resources/assets/lib/jquery-switchbutton/jquery.switchButton.js') !!}
{!! Html::script('resources/assets/lib/peity/jquery.peity.js') !!}
{!! Html::script('resources/assets/lib/chartist/chartist.js') !!}
{!! Html::script('resources/assets/lib/chartist/chartist.js') !!}
